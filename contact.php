				...
				<div class="col-lg-3 offset-xl-1 contact_col">
					<div class="contact_info">
						<div class="contact_info_section">
							...
							<ul>
								<li>Phone: <span>+381 69 1414 022</span></li>
								<li>Email: <span>marketing-pp@gmail.com</span></li>
							</ul>
						</div>
						<div class="contact_info_section">
							<div class="contact_info_title">Shipping & Returns</div>
							<ul>
								<li>Phone: <span>+381 69 1414 023</span></li>
								<li>Email: <span>shipping-pp@gmail.com</span></li>
							</ul>
						</div>
						<div class="contact_info_section">
							<div class="contact_info_title">Information</div>
							<ul>
								<li>Phone: <span>+381 69 1414 024</span></li>
								<li>Email: <span>contact-pp@gmail.com</span></li>
							</ul>
						</div>
					</div>
				</div>
